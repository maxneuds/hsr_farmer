...
class Audition_Venue:
    ...
    async def path_1(self):
        ...
        await self.bot.use_teleporter(x=1163/2400, y=681/1080, corner='topleft', move_x=0, move_y=7, x2=661/2400, y2=750/1080) # Superstar Showdown: Arena I
    ...
    async def path_3(self):
        ...
        await self.bot.use_teleporter(x=1162/2400, y=741/1080, corner='botright', move_x=0, move_y=6, x2=610/2400, y2=326/1080) # Dreamplay Fantasia: Acting Challenge
    ...
    async def path_4(self):
        ...
        await self.bot.use_teleporter(x=1235/2400, y=690/1080, corner='topleft', move_x=0, move_y=6, x2=805/2400, y2=861/1080, confirm=True, confirm_x=1259/2400, confirm_y=764/1080) # Superstar Showdown: Arena II
