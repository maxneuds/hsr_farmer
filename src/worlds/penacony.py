...
class Init:
    ...
    async def dev(self):
        await self.the_reverie_dreamscape.farm(mode=self.mode) # TP:-22->1 XP:14580/15552 Time:?
        raise SystemExit()
        await self.dewlight_pavilion.farm() # TP:-21->1 XP:11448/11448 Time: TP:2->1 R2:5
