...
class Init:
    ...
    async def farm(self):
        ...
        R4: 2
        '''
        await self.dreams_edge.farm() # TP:-12->1 R4:2 XP:7668/9612 Time:431    
        await self.storage_zone.teleport(tp_restore=4) # TP:+4->5 Time:???
        ...
        await self.the_reverie_dreamscape.farm(mode=self.mode) # TP:-???->1 R2:5(credits)8(xp) XP:14580/15552 Time:?
        await self.golden_hour.restore_tp(tp=4.2) # TP:+4->5 Time:80
        await self.dewlight_pavilion.farm(mode=self.mode) # TP:-22->1 R2:5(credits)7(xp) XP:11448/11448 Time:
        await self.the_soaring_clock_hand.restore_tp(tp=4)
        await self.childs_dream.farm() # TP:-9->2 R2:4 XP:5832/5832 Time:???
        # todo split into xp mode
        if self.mode == 'xp':
            pass
    async def dev(self):
...
class Dreams_Edge:
    ...
    async def path_3(self):
        ...
        await self.bot.movepi(1.95, 2900)
        await self.bot.movepi(0.45, 2000)
    ...
    async def path_6(self):
        logger_set_path(6)
        await self.bot.use_teleporter(933/2400, 535/1080, move_x=0, move_y=5, corner='topright') # Dreamweaver Plaza
        raise SystemExit('check,edge,path6')
...
class Childs_Dream:
    ...
    async def path_2(self):
        ...
        await self.bot.movepi(1.88, 9400)
        await self.bot.interact()
        await self.bot.movepi(1.95, 2900)
...
class The_Reverie_Dreamscape:
    ...
    async def path_5(self):
        ...
        await self.bot.movepi(0.48, 300)
    ...
    async def path_10(self):
        ...
        await self.bot.posfix(1.75, 1000)
        await self.bot.movepi(0.55, 500)
        await self.bot.attack_technique(6) # move
        await self.bot.movepi(1.0, 500)
    ...
    async def path_12(self):
        ...
        await self.bot.movepi(0.825, 500)
        await self.bot.attack_technique(6) # move
        await self.bot.movepi(1.0, 500)
        ...
        await self.bot.movepi(0.5, 2300)
        await self.bot.movepi(1.85, 1500)
        await self.bot.interact()
        await self.bot.movepi(1.25, 1000)
        await self.bot.posfix(1.25, 1000)
        await self.bot.movepi(0.5, 1500)
        await self.bot.movepi(0.75, 2700)
    ...
    async def path_13(self):
        ...
        raise SystemExit('check end position in corner')
        await self.bot.posfix(1.75, 1000)
    ...
    async def path_15(self):
        ...
        for _ in range(5): # items -1TP
            await self.bot.movepi(1.9, 300)
            await self.bot.attack_technique(1)
        await self.bot.movepi(0.4, 2000) # move to top right corner
        await self.bot.posfix(0.25, 1000)
        await self.bot.movepi(1.1, 600)
        await self.bot.interact()
        await self.bot.movepi(1.0, 2500)
    ...
    async def path_17(self):
        ...
        await self.bot.action_button()
        await self.bot.movepi(0.5, 1500)
        await self.bot.movepi(1.9, 2400)
        await self.bot.movepi(1.5, 700)
        await self.bot.action_button()
        await self.bot.movepi(1.5, 1500)
...
class Dewlight_Pavilion:
    ...
    async def path_1(self):
        ...
        await self.bot.posfix(1.25, 1000)
        await self.bot.movepi(1.6, 2800)
        await self.bot.action_button()
    ...
    async def path_8(self):
        ...
        raise SystemExit('check,dew,path8')
        ...
        await self.bot.attack_technique(2) # move
        await self.bot.movepi(1.85, 500)
        await self.bot.attack_technique(3) # items
        await self.bot.movepi(0.9, 2000)   
        await self.bot.posfix(0.75, 500)
    ...
    async def path_11(self):
        logger_set_path(11)
        await self.bot.use_teleporter(912/2400, 485/1080, move_x=0, move_y=2, corner='topleft', confirm=True) # Dreammaster Hall
        ...
        await self.bot.movepi(1.0, 300)
        await self.bot.attack_technique(8) # -2TP
    async def path_extraxp(self):
        # disabled: choose the tp object over these 2 enemies
        logger_set_path('extraxp')
        await self.bot.use_teleporter(1333/2400, 502/1080, move_x=0, move_y=0, corner='botleft', special_exit=False) # City Sandpit
        await self.bot.movepi(0.5, 11500)
        await self.bot.interact(wait_for_ready=False)
        await self.bot.action_tap(1535, 960)
...
class Penacony_Grand_Theater:
    ...
    async def path_1(self):
        ...
        await self.bot.movepi(0.31, 2200)
        await self.bot.attack() # +2TP
        await self.bot.movepi(1.6, 1000)
        await self.bot.movepi(0.1, 2500)
        await self.bot.attack() # items
        await self.bot.movepi(1.6, 500)
        await self.bot.movepi(0.1, 4000)
        await self.bot.movepi(0.25, 2500)
        await self.bot.movepi(0.4, 500)
        await self.bot.attack() # items
        await self.bot.movepi(0.25, 300)
        ...
        await self.bot.movepi(1.7, 1000)
        await self.bot.movepi(0.35, 5000)
        await self.bot.movepi(0.5, 1500)
        await self.bot.attack_technique(1) # -1TP
    ...
    async def path_3(self):
        logger_set_path(3)
        await self.bot.use_teleporter(1251/2400, 469/1080, move_x=0, move_y=8, swipe=2, corner='botright') # Communing Hall
        await self.bot.movepi(0.62, 2400)
        await self.bot.attack(2) # items
        await self.bot.movepi(0.0, 2100)
        await self.bot.attack() # items
    ...
    async def path_4(self): # 3->3
        logger_set_path(4)
        await self.bot.use_teleporter(1251/2400, 469/1080, move_x=0, move_y=8, swipe=2, corner='botright') # Communing Hall
        await self.bot.movepi(0.5, 6000)
    ...
    async def path_6(self):
        ...
        await self.bot.movepi(0.25, 300)
        await self.bot.attack_technique(5) # items
        await self.bot.movepi(0.69, 300)
        await self.bot.attack_technique(6) # items
        await self.bot.movepi(0.33, 300)
        await self.bot.attack_technique(6) # items
    async def path_7(self):
        logger_set_path(7)
        ...
        await self.bot.movepi(0.83, 2500)
        await self.bot.attack_technique(1) # items
        await self.bot.movepi(1.3, 300)
    ...
    async def path_8(self):
        logger_set_path(8)
        await self.bot.use_teleporter(900/2400, 184/1080, move_x=0, move_y=9, swipe=2, corner='botright') # Bud of Erdutition
        await self.bot.movepi(1.37, 500)
    ...
    async def path_9(self):
        ...
        await self.bot.movepi(1.0, 2000)
        await self.bot.movepi(0.9, 1000)
        await self.bot.movepi(0.7, 1600)
        await self.bot.attack_technique(2) # +2TP
        await self.bot.movepi(0.75, 2000)
        await self.bot.posfix(0.75, 1000)
        await self.bot.movepi(1.4, 2000)
    ...
    async def path_10(self):
        ...
        await self.bot.movepi(1.3, 1400)
        await self.bot.attack_technique(1) # +2TP
        await self.bot.movepi(0.1, 500)
        await self.bot.attack_technique(6) # items
        await self.bot.movepi(0.25, 1000)
        await self.bot.posfix(0.25, 1000)
        await self.bot.movepi(1.5, 1000)
        await self.bot.movepi(1.8, 7000)
...
class The_Soaring_Clock_Hand:
    ...
    async def teleport(self, tp):
        ...
        if tp == 4:
            ...
            await self.bot.movepi(0.75, 3200)
            await self.bot.movepi(0.5, 3200)
            await self.bot.movepi(1.0, 300)
            await self.bot.attack_technique(2) # items
            await self.bot.movepi(1.1, 2000)
