...
class World:
    ...
    async def farm_artisan_commission(self):
        ...
        await self.bot.attack()
        await self.bot.wait_for_onmap()
        logger('### group 10, part 2 ###') # stability: roamer
        ...
        await self.bot.dev.shell(cmd)
        await aio.sleep(3)
        await self.bot.use_teleporter(int(self.xy.width*886/2400), int(self.xy.height*161/1080))
        await self.bot.move('sw', 3000)
        await self.bot.move('w', 8000)
        await self.bot.move('s', 1500)
        await self.bot.move('w', 5000)
        ...
        await self.bot.dev.shell(cmd)
        await aio.sleep(3)
        await self.bot.use_teleporter(int(self.xy.width*1347/2400), int(self.xy.height*283/1080))
        await self.bot.move('w', 1000)
        ...
        await self.bot.attack()
        await self.bot.wait_for_onmap()
        logger('### group 14, part 2 ###') # stability: roamer
        await self.bot.move('e', 500)
        await self.bot.attack()
        await self.bot.wait_for_onmap()
        logger('### group 14, part 3 ###') # stability: roamer
        await self.bot.move('ne', 1500)
        await self.bot.attack()
        await self.bot.wait_for_onmap()
        logger('### group 15 ###')
        await self.bot.open_map()
        await self.bot.use_teleporter(int(self.xy.width*983/2400), int(self.xy.height*280/1080))
        await self.bot.move('w', 1000)
        await self.bot.move('s', 900)
        await self.bot.move('e', 1800)
        await self.bot.move('n', 2500)
