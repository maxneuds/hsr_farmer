...
class World:
    ...
    async def farm_fyxestroll_garden(self):
        ...
        await self.bot.movepi(1.8, 2800)
        await self.bot.attack()
        await self.bot.wait_for_onmap(min_duration=30)
        logger('### group 2 ###')
        await self.bot.use_teleporter(845/2400, 690/1080) # Cavern of Corrosion
        await self.bot.movepi(1.8, 2000)
        await self.bot.movepi(0.01, 2800)
        await self.bot.movepi(1.8, 2800)
        await self.bot.movepi(0.225, 4200)
        await self.bot.movepi(0.61, 1600)
        await self.bot.attack()
        await self.bot.wait_for_onmap()
        logger('### group 3 ###')
        await self.bot.use_teleporter(845/2400, 680/1080) # Cavern of Corrosion
        await self.bot.movepi(1.8, 2000)
        await self.bot.attack()
        await self.bot.sleep(0.5)
        await self.bot.movepi(0.01, 2800)
        await self.bot.movepi(1.8, 2800)
        await self.bot.movepi(0.225, 4200)
        await self.bot.movepi(0.28, 2000)
        await self.bot.movepi(0.15, 1200)
        await self.bot.attack()
        await self.bot.wait_for_onmap()
        logger('### group 4 ###')
        await self.bot.use_teleporter(580/2400, 738/1080) # Locufox Forest Backdoor
