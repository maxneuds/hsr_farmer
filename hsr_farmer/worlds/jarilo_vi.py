...
class World:
    ...
    async def farm(self):
        ...
        # await self.farm_everwinter_hill()
        # await self.farm_great_mine()
    ...
    async def farm_everwinter_hill(self):
        ...
        await self.bot.movepi(0.95, 1300)
        await self.bot.attack()
        await self.bot.wait_for_onmap()
        logger('### group 2 ###')
        await self.bot.movepi(1.1, 2000)
        await self.bot.movepi(0.8, 1800)
        await self.bot.movepi(0.85, 500)
        await self.bot.attack()
        await self.bot.wait_for_onmap()
        logger('### group 3 ###')
        await self.bot.open_map()
        await self.bot.use_teleporter(int(self.xy.width*1150/2400), int(self.xy.height*727/1080))
    ...
    async def farm_corridor(self):
        ...
        await self.bot.movepi(1.42, 3000)
        await self.bot.attack()
        await self.bot.wait_for_onmap()
        logger('### group 7 ###')
        await self.bot.open_map()
        await self.bot.use_teleporter(int(self.xy.width*741/2400), int(self.xy.height*526/1080))
