...
class World:
    ...
    async def farm_great_mine(self):
        ...
        await self.bot.sleep(0.5)
        await self.bot.movepi(0.55, 600)
        await self.bot.attack()
        await self.bot.wait_for_onmap()
        logger('### group 9 ###') # roamer
        await self.bot.movepi(0.55, 1700)
    ...
    async def farm_corridor(self): # TODO: do battle 4 first
        ...
        await self.bot.wait_for_onmap()
        logger('### group 6 ###')
        await self.bot.use_teleporter(909/2400, 655/1080) # Stagnant Shadow
        await self.bot.movepi(1, 1000)
        await self.bot.movepi(0.75, 1550)
        await self.bot.movepi(0.5, 1500)
        await self.bot.movepi(1, 3800)
        await self.bot.movepi(0.48, 5600)
        await self.bot.movepi(0.249, 500)
        await self.bot.attack()
        await self.bot.wait_for_onmap(min_duration=30)
        logger('### group 7 ###')
        await self.bot.use_teleporter(911/2400, 645/1080) # Stagnant Shadow
        await self.bot.movepi(1, 1000)
        await self.bot.movepi(0.75, 1550)
        await self.bot.movepi(0.5, 1500)
        await self.bot.movepi(1, 3800)
        await self.bot.movepi(0.48, 5600)
        await self.bot.movepi(0.249, 6200)
        await self.bot.movepi(1.75, 600)
        await self.bot.attack()
        await self.bot.wait_for_onmap(min_duration=60)
        logger('### group 8 ###')
        await self.bot.use_teleporter(911/2400, 546/1080) # Stagnant Shadow
